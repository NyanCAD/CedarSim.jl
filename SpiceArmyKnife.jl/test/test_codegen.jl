...
function check_roundtrip(code, lang, dialect)
    ...
    gen1 = generate_code(ast1, lang, dialect)
    ...
    gen2 = generate_code(ast2, lang, dialect)
...
"""
            @test check_roundtrip(spice, :spice, :ngspice)
        end
...
"""
            @test check_roundtrip(spectre, :spectre, :spectre)
        end
    end
    ...
    @testset "SPICE Models" begin
        @testset "Simple model" begin
            ...
            output = generate_code(ast, :spice, :ngspice)
    ...
    @testset "Spectre Models" begin
        @testset "Simple model" begin
            ...
            output = generate_code(ast, :spectre, :spectre)
...
"""
    ...
    @testset "IOBuffer output" begin
        ...
        io = IOBuffer()
        generate_code(ast, io, :spice, :ngspice)
